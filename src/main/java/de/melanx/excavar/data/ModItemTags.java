...
public class ModItemTags extends IntrinsicHolderTagsProvider<Item> {
    ...
    public ModItemTags(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper helper) {
        //noinspection deprecation
        super(output, Registries.ITEM, lookupProvider, item -> item.builtInRegistryHolder().getKey(), Excavar.MODID, helper);
    }
