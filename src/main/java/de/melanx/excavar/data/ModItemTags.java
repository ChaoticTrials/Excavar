...
public class ModItemTags extends IntrinsicHolderTagsProvider<Item> {
    ...
    public static final TagKey<Item> AIOTS_ALT = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("forge", "tools/aiots"));
    public static final TagKey<Item> PAXELS_ALT = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("forge", "tools/paxels"));
